#ifndef CPU2_MEMORY_MAPPED_H
#define CPU2_MEMORY_MAPPED_H

#define __REGS_SIZE  0x00000400        // 1KB
#define __STACK_SIZE 0x00004000        // 16KB; not 0x00000400 1KB
#define __HEAP_SIZE  0x00002000        // 8KB; not 0x00000C00 3KB // FIXME cannot included in startup.S

#define USER_INT_CLR_ADDR 0x40000100 //sw0~sw7
#define USER_INT_CLR_STEP 4

#define COM_SRAM_BASEADDR  0x44000000 // 0x40010000
#define LOC_SRAM_BASEADDR  0x2012c000 // 0x44000000

#define BOOT_REMAP_CFG          (0x20132000) // (0x400fd500)
#define FUNCBOOT_ORIGIN         (0x200FC800)
#define FUNCBOOT_START          (0x2011C800)
#define FUNCBOOT_SIZE           (0x00003800) // 14KB FuncBootCodeSize
#define USER_FLASH_START        (0x20000000) 
#define USER_CODERAM_START      (0x20100000)
#define USER_SIZE               (0x0001C800) // 114KB
...
enum RISCV_REGISTER{
    ...
    OTHER_CPU1_EVENT_END_ADDR       = 0x41000024, // MIPS, accessible only if just RISCV ERR, hardware set, software clear
    OTHER_CPU2_EVENT_END_ADDR       = 0x41000028, //  ARM, accessible only if just RISCV ERR, hardware set, software clear
...
#define CLIC_INI_BASE           (0xE0801000UL)                     /*!< CLIC INT Base Address */
#define CLIC_INI_IP_OFFSET      (0x0UL)                            /*!< CLIC INT Base Address */
#define CLIC_INI_IE_OFFSET      (0x1UL)                            /*!< CLIC INT Base Address */
#define CLIC_INI_ATTR_OFFSET    (0x2UL)                            /*!< CLIC INT Base Address */
#define CLIC_INI_CTL_OFFSET     (0x3UL)                            /*!< CLIC INT Base Address */
#define CLIC_INT_INTERVAL       (4)
