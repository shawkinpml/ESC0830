#ifndef CPU1_MEMORY_MAPPED_H
#define CPU1_MEMORY_MAPPED_H

#define __REGS_SIZE  0x00000400        // 1KB
#define __STACK_SIZE 0x00000800        // 2KB; not 0x00000400 1KB
#define __HEAP_SIZE  0x00002000        // 8KB; not 0x00000C00 3KB

#define USER_INT_CLR_ADDR 0x40000100
#define USER_INT_CLR_STEP 4

#define COM_SRAM_BASEADDR  0x20000000  // 0x40010000
#define LOC_SRAM_BASEADDR  0x0012c000  // 0x44000000

#define FUNCBOOT_ORIGIN         (0x000FC800)
#define FUNCBOOT_START          (0x0011C800)
#define FUNCBOOT_SIZE           (0x00003800) // 14KB FuncBootCodeSize
#define USER_FLASH_START        (0x00000000) 
#define USER_CODERAM_START      (0x00100000)
...
enum CM3_REGISTER{
    ...
    OTHER_CPU1_EVENT_END_ADDR       = 0x41000024, // RISCV, accessible only if just ARM ERR, hardware set, software clear
    OTHER_CPU2_EVENT_END_ADDR       = 0x41000028, //  MIPS, accessible only if just ARM ERR, hardware set, software clear
