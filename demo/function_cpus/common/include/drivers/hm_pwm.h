...
//*****************************************************************************
//
// The following defines are passed to PWMGenConfigure() as the Config
...
//
//*****************************************************************************
#define PWM_GEN_0               0x00000000  // Offset address of Gen0
#define PWM_GEN_1               0x00000001  // Offset address of Gen1
#define PWM_GEN_2               0x00000002  // Offset address of Gen2
#define PWM_GEN_3               0x00000003  // Offset address of Gen3
...
//
//*****************************************************************************
#define PWM_OUT_0               0x00000000  // Encoded offset address of PWM0
#define PWM_OUT_1               0x00000001  // Encoded offset address of PWM1
#define PWM_OUT_2               0x00000002  // Encoded offset address of PWM2
#define PWM_OUT_3               0x00000003  // Encoded offset address of PWM3
#define PWM_OUT_4               0x00000004  // Encoded offset address of PWM4
#define PWM_OUT_5               0x00000005  // Encoded offset address of PWM5
#define PWM_OUT_6               0x00000006  // Encoded offset address of PWM6
#define PWM_OUT_7               0x00000007  // Encoded offset address of PWM7
...
//*****************************************************************************
//
// Defines that can be passed to the PWMClockSet() API as the Config
// parameter, and can be returned by the PWMClockGet() API.
//
//*****************************************************************************
#define PWM_SYSCLK_DIV_1        0x00000000  // PWM clock is system clock
#define PWM_SYSCLK_DIV_2        0x00000001  // PWM clock is system clock /2
#define PWM_SYSCLK_DIV_4        0x00000003  // PWM clock is system clock /4
#define PWM_SYSCLK_DIV_8        0x00000007  // PWM clock is system clock /8
#define PWM_SYSCLK_DIV_16       0x0000000F  // PWM clock is system clock /16
#define PWM_SYSCLK_DIV_32       0x0000001F  // PWM clock is system clock /32
#define PWM_SYSCLK_DIV_64       0x0000003F  // PWM clock is system clock /64
 ...
 * @{
 */
extern void PWM_Init(HM_PWM_TypeDef* pPwm);
extern void PWM_GenConfigure(HM_PWM_TypeDef* pPwm, uint32_t pwmGen,uint32_t Config);
extern void PWM_GenPeriodSet(HM_PWM_TypeDef* pPwm, uint32_t pwmGen,uint32_t Period);
extern uint32_t PWM_GenPeriodGet(HM_PWM_TypeDef* pPwm,uint32_t pwmGen);
extern void PWM_GenEnable(HM_PWM_TypeDef* pPwm, uint32_t pwmGen);
extern void PWM_GenDisable(HM_PWM_TypeDef* pPwm, uint32_t pwmGen);
extern void PWM_PulseWidthSet(HM_PWM_TypeDef* pPwm, uint32_t PWMOut,uint32_t Width);
extern uint32_t PWM_PulseWidthGet(HM_PWM_TypeDef* pPwm,uint32_t PWMOut);
extern void PWM_DeadBandEnable(HM_PWM_TypeDef* pPwm, uint32_t pwmGen,uint16_t ui16Rise, uint16_t ui16Fall);
extern void PWM_DeadBandDisable(HM_PWM_TypeDef* pPwm, uint32_t pwmGen);
extern void PWM_SyncUpdate(HM_PWM_TypeDef* pPwm, uint32_t GenBits);
extern void PWM_SyncTimeBase(HM_PWM_TypeDef* pPwm, uint32_t GenBits);
extern void PWM_OutputState(HM_PWM_TypeDef* pPwm, uint32_t PWMOutBits,Bool bEnable);
extern void PWM_OutputInvert(HM_PWM_TypeDef* pPwm, uint32_t PWMOutBits,Bool bInvert);
extern void PWM_OutputFaultLevel(HM_PWM_TypeDef* pPwm,uint32_t PWMOutBits,Bool bDriveHigh);
extern void PWM_OutputFault(HM_PWM_TypeDef* pPwm, uint32_t PWMOutBits,Bool bFaultSuppress);
extern void PWM_GenIntTrigEnable(HM_PWM_TypeDef* pPwm, uint32_t pwmGen,uint32_t IntTrig);
extern void PWM_GenIntTrigDisable(HM_PWM_TypeDef* pPwm, uint32_t pwmGen,uint32_t IntTrig);
extern uint32_t PWM_GenIntStatus(HM_PWM_TypeDef* pPwm, uint32_t pwmGen, Bool bMasked);
extern void PWM_GenIntClear(HM_PWM_TypeDef* pPwm, uint32_t pwmGen,uint32_t Ints);
extern void PWM_IntEnable(HM_PWM_TypeDef* pPwm, uint32_t GenFault);
extern void PWM_IntDisable(HM_PWM_TypeDef* pPwm, uint32_t GenFault);
extern void PWM_FaultIntClear(HM_PWM_TypeDef* pPwm);
extern uint32_t PWM_IntStatus(HM_PWM_TypeDef* pPwm, Bool bMasked);
extern void PWM_FaultIntClearExt(HM_PWM_TypeDef* pPwm,uint32_t FaultInts);
extern void PWM_GenFaultConfigure(HM_PWM_TypeDef* pPwm, uint32_t pwmGen,uint32_t MinFaultPeriod,uint32_t FaultSenses);
extern void PWM_GenFaultTriggerSet(HM_PWM_TypeDef* pPwm, uint32_t pwmGen,uint32_t Group,uint32_t FaultTriggers);
extern uint32_t PWM_GenFaultTriggerGet(HM_PWM_TypeDef* pPwm, uint32_t pwmGen,uint32_t Group);
extern uint32_t PWM_GenFaultStatus(HM_PWM_TypeDef* pPwm,uint32_t pwmGen, uint32_t Group);
extern void PWM_GenFaultClear(HM_PWM_TypeDef* pPwm, uint32_t pwmGen,uint32_t Group, uint32_t FaultTriggers);
extern void PWM_ClockSet(HM_PWM_TypeDef* pPwm, uint32_t Config);
extern uint32_t PWM_ClockGet(HM_PWM_TypeDef* pPwm);
extern void PWM_OutputUpdateMode(HM_PWM_TypeDef* pPwm,uint32_t PWMOutBits,uint32_t Mode);
