...
* 
* Copyright(C) 2021, HCW Semiconductor
* All rights reserved.
**********************************************************************/
...
/* --------------------- BIT DEFINITIONS -------------------------------------- */
/*******************************************************************//**
* I2S Enable register description
*********************************************************************/
#define I2S_IER_IEN(n)		((n&0x1))
...
void I2S_Init(HM_I2S_TypeDef *I2Sx);
void I2S_DeInit(HM_I2S_TypeDef *I2Sx);

/* I2S configuration functions --------*/
void I2S_Config(HM_I2S_TypeDef *I2Sx, uint8_t TRMode, I2S_CFG_Type* ConfigStruct);
Status I2S_FreqConfig(HM_I2S_TypeDef *I2Sx, uint32_t Freq, uint8_t TRMode);
void I2S_SetBitRate(HM_I2S_TypeDef *I2Sx, uint8_t bitrate, uint8_t TRMode);
void I2S_ModeConfig(HM_I2S_TypeDef *I2Sx, I2S_MODEConf_Type* ModeConfig, uint8_t TRMode);
uint8_t I2S_GetLevel(HM_I2S_TypeDef *I2Sx, uint8_t TRMode);

/* I2S operate functions -------------*/
void I2S_Send(HM_I2S_TypeDef *I2Sx, uint32_t BufferData);
uint32_t I2S_Receive(HM_I2S_TypeDef* I2Sx);
void I2S_Start(HM_I2S_TypeDef *I2Sx);
void I2S_Pause(HM_I2S_TypeDef *I2Sx, uint8_t TRMode);
void I2S_Mute(HM_I2S_TypeDef *I2Sx, uint8_t TRMode);
void I2S_Stop(HM_I2S_TypeDef *I2Sx, uint8_t TRMode);

/* I2S DMA functions ----------------*/
void I2S_DMAConfig(HM_I2S_TypeDef *I2Sx, I2S_DMAConf_Type* DMAConfig, uint8_t TRMode);
void I2S_DMACmd(HM_I2S_TypeDef *I2Sx, uint8_t DMAIndex,uint8_t TRMode, FunctionalState NewState);

/* I2S IRQ functions ----------------*/
void I2S_IRQCmd(HM_I2S_TypeDef *I2Sx,uint8_t TRMode, FunctionalState NewState);
void I2S_IRQConfig(HM_I2S_TypeDef *I2Sx, uint8_t TRMode, uint8_t level);
FunctionalState I2S_GetIRQStatus(HM_I2S_TypeDef *I2Sx,uint8_t TRMode);
uint8_t I2S_GetIRQDepth(HM_I2S_TypeDef *I2Sx,uint8_t TRMode);
